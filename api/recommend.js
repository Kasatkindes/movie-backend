...
Язык и орфография: первое предложение — с заглавной буквы. После каждой точки следующее предложение — с заглавной буквы.
Запрещено начинать описание с слов-паразитов: "Собственно", "Ну", "Короче", "В общем", "Если честно", "Типа". Не используй их в начале текста.
Каждое описание должно начинаться по-разному — разная структура и формулировка, без однотипных зачинов.
Стиль: без пафоса — запрещены "захватывающий", "удивительный", "шедевр". Если фильм ок — нейтрально. Бытовуха и грязь: сравнения с едой, очередями, обоями, бытовыми травмами. В середине текста можно использовать: иронично, препарировать, экзистенциальный, биопроблемы, какая-то фигня. Один абзац, 5–6 предложений. Без восклицательных знаков и эмодзи. Без обращений к читателю. Не пересказывай сюжет прямо, не начинай с "это фильм про". Образец тона (зачин каждый раз меняй): "Тут у нас опять история про то как кто-то пытается найти смысл там где его нет. Главный герой ходит с таким лицом будто у него болят зубы и экзистенциальный кризис одновременно. Всё это напоминает попытку собрать шкаф без инструкции в темноте. Иронично что финал предсказуем как очередь за бесплатными блинами. Ещё одна придурковатая попытка препарировать пустоту. Скучно как недоеденная шаурма."
